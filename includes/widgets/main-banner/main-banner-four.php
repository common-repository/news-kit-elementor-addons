...
class Main_Banner_Widget_Four extends \Nekit_Widget_Base\Base {
	protected $widget_name = 'nekit-main-banner-four';
	public static $widget_count = 'four';
	...
	public function get_custom_help_url() {
		return 'https://blazethemes.com/plugins/blaze-elementor/addons/#banner-widget-four';
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .nekit-banner-wrap .main-banner-block-posts, {{WRAPPER}} .nekit-banner-wrap .row,
					 {{WRAPPER}} .nekit-banner-wrap .main-banner-trailing-block-posts' => 'row-gap: calc( 2 * {{SIZE}}{{UNIT}} );',
					'{{WRAPPER}} .nekit-banner-wrap .main-banner-trailing-block-posts' => 'margin-top: calc( 2 * {{SIZE}}{{UNIT}} );',
					'{{WRAPPER}} .nekit-banner-wrap .post-thumb-wrap' => 'height: calc(428px + 2*{{SIZE}}{{UNIT}});'
				]
			]
		);
        $this->end_controls_section();
	...
	protected function render() {
		...
		?>
		<section class="nekit-widget-section nekit-banner-wrap main-banner-section banner-layout--four <?php echo esc_attr( 'section-column-order--' . implode('--',$settings['main_banner_sorting']) ); ?> <?php echo ( $settings['show_slider_arrow_on_hover'] == 'yes' ) ? esc_attr( 'arrow-on-hover--on' ) : esc_attr( 'arrow-on-hover--off' ); ?>">
            <div class="news-elementor-container">
								...
								case 'trailing-posts': ?>
									<div class="main-banner-block-posts banner-trailing-posts">
										<?php
											...
											$trailing_post_args['posts_per_page'] = ( $settings['trailing_post_count'] < 4 ) ? absint($settings['trailing_post_count']): 4;
				...
				<?php if( $settings['trailing_post_count'] > 4 ) : ?>
						<div class="main-banner-trailing-block-posts banner-trailing-posts">
							<?php
								$trailing_post_args['posts_per_page'] = absint( $settings['trailing_post_count'] - 4 );
