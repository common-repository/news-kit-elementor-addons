 ...
 */
 ...
 class News_Block_Two extends \Nekit_Modules\Block_Module {
    protected $widget_name = 'nekit-news-block-two';
    public static $widget_count = 'two';
     
    public function get_custom_help_url() {
        return 'https://blazethemes.com/plugins/blaze-elementor/addons/#nekit-news-block-two';
    }
    
    public function get_keywords() {
        return ['news','block','two'];
    }
					...
					<?php
						...
						if( $post_query->have_posts() ) :
							...
							while( $post_query->have_posts() ) : $post_query->the_post();
                                ...
                                if( $current_post === 0 ) echo '<div class="primary-row paged-1">';
                                    if( $current_post === 5 ) echo '<div class="secondary-row trailing-post paged-1">';
