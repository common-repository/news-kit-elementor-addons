 ...
 */
 ...
 class News_Block_Four extends \Nekit_Modules\Block_Module {
    protected $widget_name = 'nekit-news-block-four';
    public static $widget_count = 'four';
    
    public function get_custom_help_url() {
        return 'https://blazethemes.com/plugins/blaze-elementor/addons/#nekit-news-block-four';
    }
       
    public function get_keywords() {
        return ['news','block','four'];
    }
					...
					<?php
						...
						if( $post_query->have_posts() ) :
							...
							while( $post_query->have_posts() ) : $post_query->the_post();
                                ...
                                if( $current_post % 10 === 0 ) echo '<div class="primary-row paged-1"><div class="featured-post">';
                                    if( $current_post % 10 === 4 ) echo '<div class="secondary-row paged-1">';
