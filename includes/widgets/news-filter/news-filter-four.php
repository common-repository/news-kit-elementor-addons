 ...
 */
 ...
 class Filter_Widget_Four extends \Nekit_Modules\Filter_Module {
     protected $widget_name = 'nekit-news-filter-four';
     public static $widget_count = 'four';
     
     public function get_custom_help_url() {
         return 'https://blazethemes.com/plugins/blaze-elementor/addons/#nekit-news-filter-four';
        }
        
        public function get_keywords() {
            return ['news','filter','four'];
        }

    protected function render() {
		$settings = $this->get_settings_for_display();
		$elementClass = 'nekit-news-filter-four nekit-filter-widget nekit-widget-section';
        ...
        <script>
			...
			<div <?php echo wp_kses_post($this->get_render_attribute_string( 'wrapper' )); ?> data-adjustLayout="<?php echo esc_attr( $adjust_layouts ); ?>"
            data-widgetLayout="<?php echo esc_attr( 'four' ); ?>">
