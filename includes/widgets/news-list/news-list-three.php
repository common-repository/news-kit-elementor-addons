...
class List_Widget_Three extends \Nekit_Modules\List_Module {
	protected $widget_name = 'nekit-news-list-three';
	public static $widget_count = 'three';

	public function get_custom_help_url() {
		return 'https://blazethemes.com/plugins/blaze-elementor/addons/#news-list-widget-three';
	}
